...
function removeReview(bookId, reviewId) {
    ...
    const newReviews = book.review.filter(rev => rev.id !== reviewId);
    book.review = newReviews;
    books[bookIdx] = book;
...
function addBook(book){
    ...
    const listPrice = {amount:utilService.getRandomIntInclusive(30,150),currencyCode:'USD',isOnSale:false}
